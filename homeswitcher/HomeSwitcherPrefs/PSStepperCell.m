...
specifier:(PSSpecifier *)specifier {
    if (self = [super initWithStyle:style
        ...
        [[specifier propertyForKey:@"minValue"] doubleValue];
    }
    return self;
}
- (void)layoutSubviews {
    ...
    self.frame.size.width - (self.accessoryView.frame.size.width + 15);
    ...
    CGRect numberFrame = CGRectMake(detailTextLabelFrame.size.width +
                                    detailTextLabelFrame.origin.x,
