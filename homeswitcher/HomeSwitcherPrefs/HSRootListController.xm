...
cell.detailTextLabel.text = [NSString stringWithFormat:@"%.0lf", pageNumber];
cell.detailTextLabel.textColor =[UIColor colorWithRed:1 green:0.17 blue:0.33 alpha:1];
} 
...
UITableViewCell *textCell = (UITableViewCell *)[self cachedCellForSpecifierID:@"pageNumber"];
textCell.detailTextLabel.text = [NSString stringWithFormat:@"%.0lf", slider.value];
...
[UISwitch appearanceWhenContainedInInstancesOfClasses:@[[self.class class]]].onTintColor =[UIColor blackColor];

[UISlider appearanceWhenContainedInInstancesOfClasses:@[[self.class class]]].thumbTintColor =[UIColor blackColor];


[UIStepper appearanceWhenContainedInInstancesOfClasses:@[[self.class class]]].tintColor =[UIColor blackColor];
